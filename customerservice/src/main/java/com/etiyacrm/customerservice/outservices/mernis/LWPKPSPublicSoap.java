...
public class LWPKPSPublicSoap
{
    ...
    public LWPKPSPublicSoap(){}

    public LWPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LWPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LWPExtendedSoapSerializationEnvelope envelope= new LWPExtendedSoapSerializationEnvelope(LWPExtendedSoapSerializationEnvelope.VER11);
